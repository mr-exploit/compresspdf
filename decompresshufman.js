...
const inputFilePath = 'huffman_codes.txt';
const outputFilePath = 'filepdf/decode.txt';
const codecObj = new Codec();

const [encodedData, outputMessage] = codecObj.encode(inputFilePath);
const encodedDataString = encodedData.toString(); // Ubah array menjadi string

fs.writeFile(outputFilePath, encodedDataString, 'UTF-8', (err) => {
    if (err) {
